# Remote Desktop / Remote Registry / Windows Remote
...
### Enable Remote Desktop on Desktop 2(User)
...
### Advantages of Remote Desktop: Using RDP on Desktop 2(User) 
...
![Enable Remote Desktop](./screenshots/enable-remote-desktop-7.png)
...
1. To enable Remote Registry, in Desktop 2(User),
...
2. To use Remote Registry in desktop 1(Admin/helpdesk),
...
### How to setup Windows Remote in Desktop 2(User)

1. To enable Windows Remote in Desktop 2(User)
- Navigate to Control Panel -> System and Security -> System: "Launch Remote Assistance" -> "Invite someone you trust to help you" -> "Save this invitation as a file" (recommend: save file on desktop)

![Windows Remote](./screenshots/windows-remote.png)

2. To use Windows Remote in Desktop 1(Admin/helpdesk),
- Navigate to Control Panel -> System and Security -> System: "Launch Remote Assistance" -> "Help someone who has invited you" -> "Use an invitation file"

![Windows Remote](./screenshots/windows-remote-2.png)

- In File Explorer -> Network, search for path of user desktop (Ex: \\desktop2\c$) -> Users -> select user account(Ex: danny) -> Desktop(or where invitation file was placed) -> open invitation file
