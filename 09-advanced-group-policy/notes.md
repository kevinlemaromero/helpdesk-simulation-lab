...
### How To Disable Task Manager using Group Policy Management (Windows Server 2016 VM)
...
3. Select "Task Manager" GPO -> "Delegation" tab, add desktop 2 user (Ex: danny)
...
- Right-click Group Policy and select "Enforced"
...
- right-click taskbar(bottom screen) and Task Manager should be greyed out
