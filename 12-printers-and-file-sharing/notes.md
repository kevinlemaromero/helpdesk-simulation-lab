...
2. On Print Management, navigate to Print Servers -> Server(Ex: Server2016) -> right-click Printers -> Add Printer
...
1. In Print Management, right-click Printer name -> select "Properties"
