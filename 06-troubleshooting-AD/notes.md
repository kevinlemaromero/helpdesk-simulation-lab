# Common Active Directory Issues and Command Line Commands

## Common Active Directory Issues on Desktop 2 (User account)

### Troubleshooting Active Directory Scenarios

1. Scenario (User): User Account is locked out
...
2. Scenario (User): User account is disabled
...
3. Scenario (User): User account password needs to be reset
...
4. Scenario (User): User Account has expired
